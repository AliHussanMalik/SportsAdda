...
const JWT_SECRET = process.env.JWT_SECRET || 'sportsadda_jwt_secret_key_production_2026';
const REFRESH_SECRET = process.env.REFRESH_SECRET || 'sportsadda_refresh_secret_key_production_2026';
